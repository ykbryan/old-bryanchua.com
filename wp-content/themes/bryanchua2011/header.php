...
<head id="www-bryanchua-com" data-template-set="html5-reset-wordpress-theme" profile="http://gmpg.org/xfn/11">
	...
	<meta name="author" content="Bryan Chua">
	<meta name="Copyright" content="Copyright Bryan Chua 2011. All Rights Reserved.">
	...
	<script src="<?php bloginfo('template_directory'); ?>/js/jquery-ui-1.8.16.custom.min.js"></script>
	...
	<script src="<?php bloginfo('template_directory'); ?>/js/jQuery.jPlayer.2.1.0/jquery.jplayer.min.js"></script>
    <script src="<?php bloginfo('template_directory'); ?>/js/jQuery.jPlayer.2.1.0/jplayer.playlist.min.js"></script>
    <script src="<?php bloginfo('template_directory'); ?>/js/jPlayer.js"></script>
